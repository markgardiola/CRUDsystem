...
const SanJuanLaiya = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/resorts/location/Calatagan, Batangas")
  ...
  return (
    <div className="container mt-5 py-5">
      ...
      >
        Escape to paradise at Calatagan Beach Resorts — where crystal-clear
        waters meet serene shores for the perfect getaway.
      </p>
      <div className="row">
        {resorts.map((resort) => (
